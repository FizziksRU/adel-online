...
// Короткий текст эффекта предмета — для полной карточки (ItemCard, size:full).
// Держим здесь, рядом с ITEMS: карточка — это UI поверх данных, а данные для
// UI живут в data.js. Тексты сверены с поведением движка (activate/actSpecial).
// Ключевые предметы: у них «эффект» — принадлежность к миссии и роль финала.
export const ITEM_EFFECTS = {
  // ключевые
  blue_card: 'Ключевой предмет синей миссии. Доставить на терминал доставки.',
  id_badge: 'Ключевой предмет синей миссии. Доставить на терминал доставки.',
  axe: 'Ключевой предмет синей миссии. Финал: активировать в лок. 20.',
  chipItem: 'Ключевой предмет красной миссии. Доставить на терминал доставки.',
  toolbox: 'Ключевой предмет красной миссии. Доставить на терминал доставки.',
  helmet: 'Ключевой предмет красной миссии. Финал: побег из лок. 16.',
  lens: 'Ключевой предмет обеих миссий.',
  // прочие
  stims: 'Активация: +3 кубика действий на этот ход.',
  drone: 'Разведка: показывает предмет в выбранной локации. С зарядом.',
  medkit: 'Вскрыть: 3 лечения себе или соседям по локации (Эмма — 4).',
  extinguisher: 'Тушит пожар в вашей локации и в тех, куда войдёте (до 3 за ход).',
  battery: 'Снимает блокировку компьютера/терминала, чинит терминал тревоги. С зарядом.',
  teddy: 'Постоянно: +1 к порогу проверки духа.',
  parts: 'Две детали + лаборатория → собрать предмет (одно действие).',
  suit: 'Позволяет выходить в открытый космос. Разрядка в космосе — гибель.',
  flashlight: 'Отключает тьму в вашей локации. С зарядом.',
};
...
// Расшифровка стоимости действия для тултипа («3 базовых + 1 тьма»). Ключи
// совпадают с модификаторами в actionCost. Интерфейс показывает на кнопке общее
// число кубиков, а из чего оно сложилось — здесь.
export const COST_MOD_NAMES = {
  base: 'базовых', dark: 'тьма', malware: 'вредоносная программа',
};
